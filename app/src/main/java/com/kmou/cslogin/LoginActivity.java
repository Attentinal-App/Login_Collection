...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Facebook 로그인 버튼 클릭 처리
        ImageView facebookLoginButton = findViewById(R.id.btn_facebook);
        facebookLoginButton.setOnClickListener(v -> {
            ...
            LoginManager.getInstance().registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
                ...
                public void onCancel() {
                    Toast.makeText(LoginActivity.this, "Facebook 로그인 취소", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onError(FacebookException error) {
                    Toast.makeText(LoginActivity.this, "Facebook 로그인 실패: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        });
    ...
    private void handleFacebookAccessToken(AccessToken token) {
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                saveUserInfoToPreferences(firebaseAuth.getCurrentUser());
                navigateToActivity(firebaseAuth.getCurrentUser(), "Facebook");
            } else {
                Toast.makeText(this, "Facebook 로그인 실패", Toast.LENGTH_SHORT).show();
            }
        });
    }
