...
class DataActivity : BaseActivity() {
    ...
    private fun submitData() {
        try {
            ...
            firebaseHelper.sendData(
                ...
                machineStatus,
                musicStatus,
                dataCollector.getAverageLightLevel().toDouble(), // 조도 데이터
    ...
    // 1분마다 데이터를 자동으로 전송하는 메서드
    private fun startAutoSendData() {
        ...
        // 1분마다 실행 시작
        handler.postDelayed(dataSendRunnable, TimeUnit.MINUTES.toMillis(1))
    }
